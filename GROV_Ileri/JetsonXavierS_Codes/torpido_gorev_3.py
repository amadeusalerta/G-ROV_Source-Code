...
def yukseklikAyar():
    ...
    global son_asagi_hiz

    if True:

        if True:
            
            alt_mesafe = grov[yukseklikMod].asagiMesGet()
            ...
            if alt_mesafe >= 1250:
                ...
                grov[yukseklikMod].asagiGit(asagi_hiz)
                ...
                sure = 0.4
                if time() % sure*2 < sure:
                    grov[yukseklikMod].onKaldir(125)
                else:
                    grov[yukseklikMod].arkaKaldir(125)
                pass

            else:
                grov[yukseklikMod].ustMotorlarDurdur()
                pass
