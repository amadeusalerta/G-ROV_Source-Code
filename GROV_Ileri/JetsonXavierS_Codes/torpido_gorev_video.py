...
while not suya_girdi:
    ...
    mesafeler["on_mesafe"] = onMesGet()
    mesafeler["arka_mesafe"] = arkaMesGet()
    mesafeler["sag_mesafe"] = sagMesGet()
    mesafeler["sol_mesafe"] = solMesGet()
    mesafeler["alt_mesafe"] = asagiMesGet()
...
while True:
    ...
    if True:
        ...
        if not yorunge_mod:
            ...
            while on_mesafe == 0 or on_mesafe >= 200:
                grov["UART"].ileriGit(100, 100)
